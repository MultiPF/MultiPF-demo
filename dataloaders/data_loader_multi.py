...
class KShotTaskSampler(Sampler):
    def __init__(self,
        ...
        self.episodes_per_epoch = episodes_per_epoch  # The number of episodes included in each epoch
...
class EpisodicDataset(Dataset):
    ...
    def __getitem__(self, item):
        # Return file name and tag as sample
    ...
    def index_subset(path):
        ...
        return images  # File name, current class name, all class names included in the image
